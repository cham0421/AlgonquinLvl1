...
print("Actual:   area = {}".format( round(cham0421Library.calculateAreaOfCircle(5), 2) ))

print("Testing Area of a Circle Number 2 with radius = 13.5")
print("Expected: area = 572.56") 
print("Actual:   area = {}".format( round(cham0421Library.calculateAreaOfCircle(13.5),2) ))

print("Testing Area of a Circle Number 3 with radius = 50")
print("Expected: area = 7853.98") 
print("Actual:   area = {}".format( round(cham0421Library.calculateAreaOfCircle(50),2) ))
