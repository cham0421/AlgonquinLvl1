...
print("Actual:   mpg = {}".format( round(lab4.calculateMpg(50 , 33),2) ))

print("Testing Calculatings MPG. Expected: miles = 16, gallon = 3")
print("Expected: mpg = 5.33")
print("Actual:   mpg = {}".format( round(lab4.calculateMpg(16 , 3),2 )))

print("Testing Calculatings MPG. Expected: miles = 99, gallon = 102")
print("Expected: mpg = 0.97")
print("Actual:   mpg = {}".format( round(lab4.calculateMpg(99 , 102),2 )))
